...
namespace SubDialogBot
{
    ...
    /// </summary>
    public class SubDialogBotAccessors
    {
        /// <summary>
        ...
        public SubDialogBotAccessors(ConversationState conversationState)
        {
        ...
        public static string CounterStateName { get; } = $"{nameof(SubDialogBotAccessors)}.CounterState";
